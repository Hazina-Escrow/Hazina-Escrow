...
const replacements = [
  ...
  { from: "app.use('/api/agent', agentRouter);", to: "app.use('/api/v1/agent', agentRouter);" },
  { from: "app.use('/api/datasets', datasetsRouter)", to: "app.use('/api/v1/datasets', datasetsRouter)" },
  { from: "app.use('/api/datasets', datasetsRouter);", to: "app.use('/api/v1/datasets', datasetsRouter);" },
  { from: "app.use(\"/api/webhooks\", webhooksRouter)", to: "app.use('/api/v1/webhooks', webhooksRouter)" },
  { from: "app.use('/api/webhooks', webhooksRouter)", to: "app.use('/api/v1/webhooks', webhooksRouter)" },
